...
- **Hardware & IoT**:  
  ...
  - PCB design and CAD prototyping using **KiCad**, **LTSpice**, **Falstad**, **EasyEDA** and **Onshape**.  
  - Certified to work on electrical systems up to 1000V ([**SEP license**](https://sep.com.pl/en/) – Poland).
