...
- **Software Development**: Full-stack **AI** applications with **TypeScript**, **Python**, **C++/C#** (examples in my public repositories).  
  ...
  - Creator of **ChipTree** — a real-time IoT platform with devices achieving 99.99% uptime, validated through automated testing, and supporting OTA updates over Wi-Fi. [ChipTree](https://chiptree.pl)
Got attention from [inQube](https://inqube.pl).
- **Hardware & IoT**:  
